...
ROOT_URLCONF = 'DataCaptureSystem.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
                 'shortintervalcontrol/templates', ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'DataCaptureSystem.wsgi.application'
...
STATIC_URL = 'shortintervalcontrol/static/'

STATICFILES_DIRS = [
    "shortintervalcontrol/static",
]
